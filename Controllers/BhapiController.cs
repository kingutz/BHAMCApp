    ...
    public class BhapiController : ControllerBase
    {
...

        {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                worksheet.Cell(currentRow, 204).Value = "Q100_5_1";
                worksheet.Cell(currentRow, 205).Value = "Q100_6_1";
                ...
                worksheet.Cell(currentRow, 209).Value = "Q102";
                worksheet.Cell(currentRow, 210).Value = "Q103";
                worksheet.Cell(currentRow, 211).Value = "CreatedDate";
                ...
                foreach (var item in bhamcs)
                {
                    ...
                    worksheet.Cell(currentRow, 204).Value = item.Q100_5_1;
                    worksheet.Cell(currentRow, 205).Value = item.Q100_6_1;
                    ...
                    worksheet.Cell(currentRow, 209).Value = item.Q102;
                    worksheet.Cell(currentRow, 210).Value = item.Q103;
                    worksheet.Cell(currentRow, 211).Value = item.CreatedDate;
